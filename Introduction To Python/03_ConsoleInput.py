...
---
Taking user input in some form is one of the most
important parts of a program. If there is no user
input, then how does a program expect to interact
...
# In the above example, we used print() to *prompt* the user
...
# Notice that by providing the prompt in input(), the prompt is
# *in-line* (on the same line) as the input.
